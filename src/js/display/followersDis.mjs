...
export async function displayFollowers() {
  ...
  profile.followers.forEach((follower) => {
    ...
    cardLink.classList.add("d-flex", "align-items-center", "gap-2","link-body-emphasis", "text-decoration-none","custom-hover");
  ...
  followersContainer.appendChild(container);
